            ...
            <div class="card-content">
                <div class="card-body">
                  ...
                  <table id="invoices-list" class="table table-white-space table-bordered display no-wrap icheck table-middle">
                            ...
                            <tr>
                            <td><img src="https://flagsapi.com/{{ $cc->flag }}/flat/64.png" alt="{{ $cc->name_ar }}" width="50"></td>
                            <td>{{ $cc->name }}</td>
                            <td>{{ $cc->currency }}</td>
                            <td>{{ $cc->updated_at }}</td>
                                        <td>
                                            <span class="dropdown">
                                                ...
                                                @can('edit_country')<span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right"><a href="{{ route('country.edit', $cc->id) }}" class="dropdown-item"><i class="fa fa-pencil"></i> Edit country</a></span> @endcan
                                            </span>
                                        </td>
                                    </tr>
                                    @endforeach

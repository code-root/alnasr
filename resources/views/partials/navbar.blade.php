      ...
      <div class="container">
        <div class="main-header">
          ...
          <div class="header-nav">
            <nav class="nav-main-menu d-none d-xl-block">
              <ul class="main-menu">
                ...
                <li class="has-children"><a class="active" href="/">categories</a>
                  <ul class="sub-menu">
                 ...
                 <li><a class="color-gray-500" href="{{ route('page_about') }}#Projects">Projects</a></li>
          ...
          {{-- <div class="header-right text-end">
            ...
            <a class="btn btn-linear d-none d-sm-inline-block hover-up hover-shadow" href="{{ route('page_about') }}#Pricing">Subscribe</a>
          </div> --}}
        </div>
      </div>
    </header>
              ...
              <div class="mobile-menu-wrap mobile-header-border">
                  <nav class="mt-15">
                      <ul class="mobile-menu font-heading">
                          ...
                          <li><a  href="{{ route('page_about') }}">Who are we</a></li>

								...
								<div class="col-4 col-xs-6 col-sm-6 col-md-4 col-lg-4">
									<figure class="gallery-item">
										<a href='assets/images/post5.jpg'>
											<img src="{{asset('assets')}}/images/post5-1024x683.jpg" alt="" />
										</a>
									</figure>
								</div>
								...
								<div class="col-4 col-xs-6 col-sm-6 col-md-4 col-lg-4">
									<figure class="gallery-item">
										<a href='assets/images/post4.jpg'>
											<img src="{{asset('assets')}}/images/post4-1024x683.jpg" alt="" />
										</a>
									</figure>
								</div>
								...
								<div class="col-4 col-xs-6 col-sm-6 col-md-4 col-lg-4">
									<figure class="gallery-item">
										<a href='assets/images/post3.jpg'>
											<img src="{{asset('assets')}}/images/post3-1024x683.jpg" alt="" />
										</a>
									</figure>
								</div>
								...
								<div class="col-4 col-xs-6 col-sm-6 col-md-4 col-lg-4">
									<figure class="gallery-item">
										<a href='assets/images/post1.jpg'>
											<img src="{{asset('assets')}}/images/post1-1024x683.jpg" alt="" />
										</a>
									</figure>
								</div>
								...
								<div class="col-4 col-xs-6 col-sm-6 col-md-4 col-lg-4">
									<figure class="gallery-item">
										<a href='assets/images/post6.jpg'>
											<img src="{{asset('assets')}}/images/post6-1024x683.jpg" alt="" />
										</a>
									</figure>
								</div>
	...
	<script src="{{asset('assets')}}/js/scroll-out.js"></script>
	<script src="{{asset('assets')}}/js/jquery.pagepiling.js"></script>
	<script src="{{asset('assets')}}/js/jquery.easy_number_animate.js"></script>

                                                ...
                                                <button id="btnSearchDrop2" type="button" data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="true" class="btn btn-primary dropdown-toggle dropdown-menu-right"><i
                                                        ...
                                                        <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            @can('edit_projects')<a href="{{ route('projects.edit', $cc->id) }}" class="dropdown-item"><i class="fa fa-pencil"></i> Edit projects</a> @endcan
                                                            @can('delete_projects') <a href="#" class="dropdown-item  delete-projects" onclick="deleteP({{ $cc->id }})" data-id="{{ $cc->id }}"  ><i class="fa fa-trash" data-id="{{ $cc->id }}" ></i> Delete</a>@endcan
                                                            </span>
                                            </span>
                                        </td>
                                    </tr>
